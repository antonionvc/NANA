...
mobile: MethodMobile, 
browser: opcion == '1' ? ['NANOBOT', 'Safari', '2.0.0'] : methodCodeQR ? ['NANOBOT', 'Safari', '2.0.0'] : ['NANOBOT', 'Chrome', '20.0.04'],
auth: {
creds: state.creds,
...
global.reloadHandler = async function(restatConn) {
  ...
  conn.bye = '👋 ¡Ya regreso!, salgo hasta tener otro celular que aguante tanta buena información\n@user';
  conn.spromote = '';
  conn.sdemote = '';
